\begin{tikzpicture}[font=\ttfamily]
    ...
    \path[draw, decorate, decoration=brace] (0, \vtopprio + 0.5) -- (\timeslice * 6, \vtopprio + 0.5) node[lbl, midway, above, yshift=0.3em]{Domain 0};
    \draw (0, \vtopprio-\barheight/2) rectangle (\timeslice*6, \vtopprio+\barheight/2) 
