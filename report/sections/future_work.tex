...
acquirement will respect a preemption. The peempt function call checks if mip
...
of some external service that in it self might be deemed an information leak.
