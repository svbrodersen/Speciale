...
In the paper Time Protection: The missing OS Abstraction \cite{ge2019} a
customized version of the seL4 microkernel is presented, which aims to protect
against all possible timing channels in the OS.
...
which has the capability of cloning gives up a subset of its own allocated
