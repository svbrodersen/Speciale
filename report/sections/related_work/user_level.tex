...
This gives rise to what is known as time protection. Time protection is defined
...
protection must ensure that all execution within partitioned parts does
...
covert channels it must be, but quite a significant number of timing channels
...
such as the temporal fence \cite{wistoff2023} are still needed even if the
