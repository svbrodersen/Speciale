\begin{tikzpicture}[font=\ttfamily]
    ...
    \path[draw, decorate, decoration=brace] (0, \vtopprio + 1.5) -- (\timeslice * 8, \vtopprio + 1.5) node[lbl, midway, above, yshift=0.3em]{Domain 0};

    % First domain
    \path[draw, decorate, decoration=brace] (0, \vtopprio + 1) -- (\timeslice * 4, \vtopprio + 1) node[lbl, midway, above, yshift=0.3em]{Domain 1};
    \draw (\timeslice*2, \vtopprio-\barheight/2) rectangle (\timeslice*4, \vtopprio+\barheight/2) 
      node[lbl, midway]{PS};

    \path[draw, decorate, decoration=brace] (0, \vtopprio + 0.5) -- (\timeslice * 2, \vtopprio + 0.5) node[lbl, midway, above, yshift=0.3em]{Domain 3};
    ...
    \draw (\timeslice*4, \vtopprio-\barheight/2) rectangle (\timeslice*8, \vtopprio+\barheight/2) 
      node[lbl, midway]{Priority Scheduler};
