...
\textbf{Why QEMU?}
\begin{itemize}
  \item Full system emulation of RISC-V virtual machine
...
\textbf{Shortcomings:}
\begin{itemize}
  \item No cycle-accurate emulation: microarchitectural state (caches, TLBs, predictors) is \textit{not} modeled
...
\vspace{0.2cm}
\begin{center}
\resizebox{0.9\textwidth}{!}{\input{figures/domain_full.tex}}
\end{center}
