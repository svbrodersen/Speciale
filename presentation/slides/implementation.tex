...
\textbf{Problem:} With multiple domains, which ready queue should a blocked task wake up on?
...
\vspace{0.15cm}
{\small Itroduces timing channels for tasks with access to the \texttt{Queue} object.}
